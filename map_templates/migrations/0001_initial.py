    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dash_array', models.CharField(blank=True, default=None, help_text='Chaîne de charactères définissant le motif de la bordure des formes.', max_length=5, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('name', models.CharField(help_text='Nom de la tuile de carte.', max_length=100, verbose_name='Nom')),
                ('verbose_name', models.CharField(blank=True, default=None, help_text="Le nom d'affichage de la tuile de carte. Laisser vide pour utiliser le nom par défaut.", max_length=100, null=True, verbose_name="Nom d'affichage")),
                ...
                ('url', models.URLField(blank=True, default=None, help_text="L'URL 'XYZ' de la tuile de carte.", null=True, verbose_name='URL')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('highlight', models.OneToOneField(blank=True, default=None, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='highlight_of', to='map_templates.style')),
                ('style', models.OneToOneField(blank=True, default=None, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='style_of', to='map_templates.style')),
            ],
            options={
                'verbose_name': 'Couche',
